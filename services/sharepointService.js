...
const getExistingDealFolderName = async (token, siteId, driveId, safeDealName, dealId) => {
    const basePath = encodeURIComponent('asphalion/clientes');
    try {
...
exports.uploadFileToSharePoint = async (fileName, fileBuffer, dealName, dealId, subFolder = 'Ofertas') => {
    ...
    const fullPath = `asphalion/clientes/${targetDealFolder}/${subFolder}/${fileName}`;
